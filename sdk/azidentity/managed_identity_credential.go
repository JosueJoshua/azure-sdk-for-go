...
// NewManagedIdentityCredential creates a credential capable of authenticating a resource that has a managed identity.
...
func NewManagedIdentityCredential(clientID string, options *ManagedIdentityCredentialOptions) (azcore.Credential, error) {
