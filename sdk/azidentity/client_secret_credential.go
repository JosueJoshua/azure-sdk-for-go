...
// NewClientSecretCredential constructs a credential with the details needed to authenticate against Azure Active Directory with a client secret.
...
func NewClientSecretCredential(tenantID string, clientID string, clientSecret string, options *TokenCredentialOptions) (azcore.Credential, error) {
